...
const requiredKeys = [
  ...
  'delete_scope_label',
  'delete_scope_single_title',
  'delete_scope_single_description',
  'delete_scope_end_repeat_title',
  'delete_scope_end_repeat_description',
  'delete_scope_delete_repeat_title',
  'delete_scope_delete_repeat_description',
  'delete_scope_delete_all_repeat_title',
  'delete_scope_delete_all_repeat_description',
  'toast_repeat_ended',
  'toast_repeat_deleted',
  'toast_repeat_all_deleted',
  'time_picker_time_label',
  ...
  'confirm_resolve_overdue_title',
  'confirm_resolve_overdue_description',
  'confirm_resolve_overdue_with_subtasks_description',
  'confirm_resolve_overdue_review_action',
  'confirm_resolve_overdue_close_action',
